...
```
  Wdeck host v0.1.0 - deck "Wdeck"
  configurazione : C:\Users\nikof\Documents\Wdeck\deck.json
  dry-run        : disattivato
  azioni         : delay, hotkey, http, launch, media, navigate, noop, script, sequence, stub, text, url
...
**PIN** (`settings.security.pin` in `deck.json`, di default `246810`); in
alternativa apri direttamente l'URL con `?token=...`. Da Chrome/Edge:
menu -> *Installa app* per averlo a schermo intero come app nativa.
