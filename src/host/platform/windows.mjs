...
export const FOCUS_HELPER = [
  ...
  '  # Un tap ALT sintetico "sblocca" il foreground: Windows lo consente solo a',
  '  # chi ha ricevuto un input di recente. Senza, dalla seconda finestra in poi',
  '  # (o da un altro dispositivo) SetForegroundWindow riesce ma non alza nulla.',
